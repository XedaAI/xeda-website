...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-[hsl(157_52%_11%/0.93)] via-[hsl(158_52%_13%/0.88)] to-[hsl(157_55%_7%/0.96)]" />
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 54% 42% at 50% 65%, hsl(157 52% 10% / 0.92) 0%, hsl(157 52% 10% / 0.58) 44%, transparent 74%)",
        }}
      />
      ...
      <div className="relative z-10 container mx-auto px-6 pt-28 pb-16 text-center max-w-4xl">
        ...
        <div className="enter [--enter-delay:1.25s] inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[hsl(27_87%_71%/0.10)] border border-[hsl(27_87%_71%/0.32)] mb-8">
          <span className="w-2 h-2 rounded-full bg-[hsl(27_87%_71%)] animate-pulse" />
          <span className="text-sm text-[hsl(148_38%_92%)]">{t("hero.badge")}</span>
        </div>
        ...
        <h1 className="enter [--enter-delay:1.4s] text-[2.6rem] md:text-6xl lg:text-[4.6rem] font-semibold tracking-[-0.03em] text-[hsl(40_37%_97%)] mb-7 leading-[1.06] text-balance">
          {t("hero.title")}
          {/* The second half of the headline in a light green (9.0:1 on the
              scrim): green stays the lead colour, and the orange keeps to
              the badge dot. */}
          <span className="text-[hsl(152_45%_70%)]"> {t("hero.titleHighlight")}</span>
        </h1>

        <p className="enter [--enter-delay:1.55s] text-lg md:text-xl text-[hsl(148_18%_84%)] mb-12 max-w-[38rem] mx-auto leading-[1.65]">
          {t("hero.subtitle")}
        </p>
        ...
        <div className="enter [--enter-delay:1.7s] flex flex-col sm:flex-row items-center justify-center gap-4">
          {/* The hero is a fixed dark panel, so the CTA is fixed too: the
              primary green #2D7D5B with white text (5.0:1), hover #24694C. It
              sits on a green deeper than #184C39 (3.0:1 against it), and a
              hairline edge sharpens the outline. */}
          <Button
            size="lg"
            asChild
            className="px-8 bg-[hsl(154_47%_33%)] text-white border border-[hsl(148_38%_92%/0.22)] hover:bg-[hsl(155_49%_28%)]"
          >
          ...
          <Button 
            ...
            className="px-8 bg-transparent border-[hsl(148_38%_92%/0.30)] text-[hsl(148_38%_92%)] hover:bg-[hsl(148_38%_92%/0.10)] hover:text-[hsl(0_0%_100%)]"
          >
            {t("hero.secondary")}
          </Button>
        </div>
      ...
      <div className="enter [--enter-delay:2.1s] absolute bottom-8 left-1/2 -translate-x-1/2 animate-bounce">
        <div className="w-6 h-10 rounded-full border-2 border-[hsl(148_38%_92%/0.36)] flex items-start justify-center pt-2">
          <div className="w-1 h-2 bg-[hsl(27_87%_71%/0.8)] rounded-full" />
        </div>
      </div>
    </section>
  );
